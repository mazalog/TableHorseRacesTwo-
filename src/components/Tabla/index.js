            ...
            <div className="container">
                ...
                <div style={{ display: 'flex', overflow: 'auto' }}>
                    ...
                    <div className="container-pagan">
                        ...
                        <div className="box-paganlg"><h4> 💵 {format(totalTabla1 + totalAcumulado())}$</h4></div>
                        {/* <div className="box-paganlg"><h4> 💵 {format(totalTabla1 + totalTabla2 + totalAcumulado())}$</h4></div> */}
                    </div>
                </div >
                <div className="container-premio">
                    <h1>💵 Premio: {format(totalTabla1)}$ {totalAcumulado() !== 0 ? '+ Acumulado de ' + totalAcumulado() + '$' + ' 😄 =' + format((totalTabla1) + totalAcumulado()) + '$ ' : <></>}</h1>
                ...
                <div className="container-detalles">
                    <div className="detalles">
                        ...
                        <div style={{ marginLeft: '40px' }}>
                             ...
                             */}
                            <p>🥇 Premio:{format(totalTabla1)}$</p>

                            <p>🥈 Premio ganado por casa: {DetalleEnCarrera() ? DetalleEnCarrera().ganador === 'C' ? format(totalTabla1) : 0
                                : 0}$</p>
                            <p>{DetalleEnCarrera() ? DetalleEnCarrera().utilidad >= 0 ? '😃' : '😭'
                                : (totalCaballosComprados - (totalTabla1) - totalAcumulado()) === 0 ? '🤔' : totalCaballosComprados - (totalTabla1) - totalAcumulado() > 0 ? '😃' : '😭'
                            }
                                Utilidad: {format(DetalleEnCarrera() ? DetalleEnCarrera().utilidad : totalCaballosComprados - (totalTabla1) - totalAcumulado())}$</p>
                            {/* <p>{DetalleEnCarrera() ? DetalleEnCarrera().utilidad >= 0 ? '😃' : '😭'
